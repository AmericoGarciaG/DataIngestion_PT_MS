...
## 🎯 Propósito
Este archivo contiene pruebas para el módulo `service.app.alpaca_service`. La prueba principal proporcionada, `test_fetch_service_logic`, funciona más como una prueba de integración que como una prueba unitaria pura, ya que (en su forma actual) interactúa con servicios externos como Alpaca y Firestore.
