...
'''
# service/app/gcp_clients.py

## 🎯 Propósito
Este módulo centraliza la inicialización de los clientes de Google Cloud Platform (GCP) que la aplicación de servicio necesita, como el cliente de Firestore y el cliente de Pub/Sub. Proporciona instancias compartidas de estos clientes para ser utilizadas por otros módulos de la aplicación.
...
## ▶️ Uso
Este módulo no se ejecuta directamente. Otros módulos importan las instancias de cliente que proporciona:
