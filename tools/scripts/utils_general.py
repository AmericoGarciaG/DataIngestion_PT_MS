...
'''
# tools/scripts/utils_general.py

## 🎯 Propósito
Este módulo proporciona un conjunto de funciones de utilidad de propósito general, diseñadas para ser reutilizadas por diversos scripts dentro del directorio `tools/scripts/`.
Estas utilidades no son específicas de una tecnología o proveedor de nube en particular, sino que ofrecen funcionalidades comunes como la ejecución de comandos del sistema, manipulación de rutas, obtención de entrada del usuario y búsqueda de recursos.
...
## ▶️ Uso
Este módulo no está diseñado para ser ejecutado directamente. Sus funciones son importadas y utilizadas por otros scripts de herramientas.
