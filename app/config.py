...
class Settings(BaseSettings):
    ...
    # Configuración GCP
    google_cloud_project: str | None = None # Se autodetecta en GCP, útil para desarrollo local
    
    # Nombres de colecciones Firestore
    firestore_providers_collection: str = "providers"
    firestore_assets_collection: str = "assets"
    firestore_historical_bars_collection: str = "historical_bars" # O podría ser una subcolección

    # Configuración Pub/Sub
    pubsub_historical_data_topic_id: str = "historical-data-updated"
